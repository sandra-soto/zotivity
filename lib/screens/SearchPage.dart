...
class _SearchPageState extends State<SearchPage> {
  ...
  Activity baking1 = Activity(
      ...
      60, 1, BodyFocus.chest, '''Description for Baking Cookies
    Simulating a very long description
      This should be scrollable
      ...
      ...
  ...
  Activity cooking1 = Activity(
      ...
      15, 2, BodyFocus.back, '''Description for Cooking Pan Fried Tofu
    Simulating a very long description
      This should be scrollable
      ...
      ...
  ...
  Activity exercise3 = Activity(
      ...
      60, 3, BodyFocus.legs, '''Description for learning a dance
    Simulating a very long description
      This should be scrollable
      ...
      ...
                ...
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (__) => new CategoryPage(
                            ...
                            categoryList: getCategoryList(ActivityCategory.indoor.toString()))));
              },
              child: Text("Exercise"),
            ),
            RaisedButton(
                ...
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (__) => new CategoryPage(
                            ...
                            categoryList: getCategoryList(ActivityCategory.outdoor.toString()))));
              },
              child: Text("Baking"),
            ),
            RaisedButton(
                ...
                Navigator.push(
                    ...
                    new MaterialPageRoute(
                        builder: (__) => new CategoryPage(
                            ...
                            categoryList: getCategoryList(ActivityCategory.gym.toString()))));
              },
              child: Text("Cooking"),
            ),
          ],
